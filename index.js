...
// 클로저(Closure)는 함수가 자신의 스코프 외부에서 선언된 변수에 접근할 수 있는 특성을 나타냅니다. 간단히 말해, 함수가 선언될 때의 환경(스코프)을 기억하고, 이 함수가 나중에 호출될 때에도 해당 환경에 접근할 수 있게 해주는 메커니즘입니다.
