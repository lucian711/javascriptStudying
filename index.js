...
//객체프로그래밍을 지향하는 OPP는 무엇인가
// 객체지향 프로그래밍(Object-Oriented Programming)은 객체들의 상호작용으로 프로그램을 표현하려는 프로그래밍 패러다임입니다.
// 객체지향 프로그래밍은 객체를 정의하고 객체의 상호작용으로 로직을 구성하는 방식입니다.
// SOLID 원칙
...
// - 리스코프 치환 원칙이란 ?
// - 자식 클래스는 최소한 자신의 부모 클래스에서 가능한 행위는 수행할 수 있어야 한다는 원칙입니다.
...
// - 의존 역전 원칙이란 ?
// - 의존 관계를 맺을 때, 변화하기 쉬운 것 보다는 변화하기 어려운 것에 의존해야 한다는 원칙입니다.
